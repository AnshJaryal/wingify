...
from tools import  Finance_doc_tool

## Creating a task to help solve user's query
analyze_financial_document = Task(
    description="""
Analyze the uploaded financial document.
You MUST use the tool Finance_doc_tool with the provided {path}.
DO NOT make up or guess file paths.
DO NOT fabricate document names.
Always use exactly the file_path provided in inputs.
""",
    expected_output="""
...
""",
    ...
    tools=[Finance_doc_tool],
    async_execution=True,
)

## Creating an investment analysis taskno
